 ...
 */
class getHomepageTextRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HomepageTextRepository' shared autowired service.
     *
     * @return \App\Repository\HomepageTextRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HomepageTextRepository.php';

        return $container->privates['App\\Repository\\HomepageTextRepository'] = new \App\Repository\HomepageTextRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
