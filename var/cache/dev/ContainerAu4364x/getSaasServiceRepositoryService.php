 ...
 */
class getSaasServiceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SaasServiceRepository' shared autowired service.
     *
     * @return \App\Repository\SaasServiceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SaasServiceRepository.php';

        return $container->privates['App\\Repository\\SaasServiceRepository'] = new \App\Repository\SaasServiceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
