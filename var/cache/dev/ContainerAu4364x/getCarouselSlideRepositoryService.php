 ...
 */
class getCarouselSlideRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarouselSlideRepository' shared autowired service.
     *
     * @return \App\Repository\CarouselSlideRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarouselSlideRepository.php';

        return $container->privates['App\\Repository\\CarouselSlideRepository'] = new \App\Repository\CarouselSlideRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
